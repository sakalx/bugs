...
import {OrnamentBottom, Wrap} from './style';
...
function AboutPage() {
  return (
      <article>
        ...
        <Wrap>
          <p>
            As a strategic, creative, and performance-driven Front-end
            Development
            ...
            project management. I have demonstrated advanced technical
            leadership
